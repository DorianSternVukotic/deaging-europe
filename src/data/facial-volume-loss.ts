...
const clinic: Section[] = [
  {
    ...
    tldr: 'Your own fat, moved from the abdomen or thigh: pooled retention of 47% across 27 studies, 33–65% in the temples, better in still areas than mobile ones; a 12-patient five-year study found the remaining volume tracked weight gain rather than the amount injected, with satisfaction back at pre-operative levels; a 62-patient randomised comparison matched hyaluronic acid over nine months and led at twelve. An operation, a second session often, no reversal.',
    evidence: 'moderate',
    focus: 'global',
